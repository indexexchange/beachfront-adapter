...
* `beachfront-htb.js` - This is your partner module file, by default it contains a template divided into multiple sections which need to be completed.
* `beachfront-htb-validator.js` - This is the validator file for the configuration object that will be passed into your module.
* `beachfront-htb-exports.js` - A file that contains all of the modules exports (i.e. any functions that need to be exposed to the outside world).

## <a name='gettingStarted'></a>Getting Started
1. <b>Complete the beachfront-htb.js file</b>
    * beachfront-htb.js is where all of your adapter code will live.
...
2. <b>Complete the beachfront-htb-validator.js file</b>
...
3. <b>Complete the beachfront-htb-exports.js file</b>
    * This file will contain any functions that need to be exported or exposed to the outside world. Things like render functions, custom callbacks, etc. Any legacy render functions will also need to be exposed here. Anything added to the `shellInterface.BeachfrontHtb` will be accessible through `window.headertag.BeachfrontHtb`
...
In this section you will be filling out the beachfront-htb.js, beachfront-htb-exports.js, and the beachfront-htb-validator.js files to create your module.

### Step 0: Config Validation (`beachfront-htb-validator.js`)
...
### Step 2: Generate Request URL (`beachfront-htb.js`)
...
### Step 3: Response Callback (`beachfront-htb.js`)
...
### Step 4: Parsing and Storing Demand (`beachfront-htb.js`)
...
```javascript
{
    ...
    "targetingType": "slot"
    "targeting" : {
        "ix_bft_id": ["_230l09jd2"],
        "ix_bft_cpm": ["300x250_2.50"]
    },
    "price": 2.50,
    "size": [300,250],
...
### Step 5: Rendering Pixel (`beachfront-htb.js`)
...
### Step 6: Exports (`beachfront-htb-exports.js`)
...
```javascript
shellInterface.BeachfrontHtb = { //shell interface is the window variable that is accessible through the window object, currently this will always be window.headertag
    render: SpaceCamp.services.RenderService.renderDfpAd.bind(null, 'BeachfrontHtb')
};
```
...
```javascript
if (__directInterface.Layers.PartnersLayer.Partners.BeachfrontHtb) {
    shellInterface.BeachfrontHtb = shellInterface.BeachfrontHtb || {};
    shellInterface.BeachfrontHtb.adResponseCallback = __directInterface.Layers.PartnersLayer.Partners.BeachfrontHtb.adResponseCallback;
}
```
...
if (__directInterface.Layers.PartnersLayer.Partners.BeachfrontHtb) {
    shellInterface.BeachfrontHtb = shellInterface.BeachfrontHtb || {};
    shellInterface.BeachfrontHtb.adResponseCallbacks = __directInterface.Layers.PartnersLayer.Partners.BeachfrontHtb.adResponseCallbacks;
}
```
